...
// Components
import { Box, Flex, Button, Text, Input, Textarea, Link, Themed } from "theme-ui";
    ...
    <Layout>
      ...
      <Box sx={{
        ...
        {isSubmitting && !isPostSuccessful &&
          <Flex sx={{ height: "100%", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
            <Loader />
          </Flex>}
        ...
        {isPostSuccessful &&
          <Flex sx={{ height: "100%", justifyContent: "center", alignItems: "center", textAlign: "center" }}>
            <Box textAlign="center">
              ...
              <Text variant="regular" sx={{ my: 3, display: "block" }}> I'll be in touch with you shortly.</Text>
        ...
        {(!isPostSuccessful && isSubmitted) &&
          <Flex sx={{ height: "100%", justifyContent: "center", alignItems: "center", textAlign: "center" }} >
            <Box textAlign="center">
              ...
              <Text variant="regular" sx={{ my: 3, display: "block" }} >We couldn't send your email.</Text>
              <Link href="/contact"><Button>Try Again</Button></Link>
            </Box>
          </Flex>}
      </Box>
    </Layout >
